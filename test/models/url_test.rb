  ...
  #
    ...
    def test_we_can_collect_http_verbs_that_have_been_used
      ...
      assert_equal ["DELETE", "GET", "POST"], user.urls.verbs_used("identifier1")
    end
    ...
    def test_most_popular_referrers_returns_top_3
      ...
      assert_equal expected, user.urls.most_popular_referrers("identifier1")
    end
    ...
    def test_most_popular_user_agents_returns_top_3_browsers
      ...
      assert_equal expected, user.urls.most_popular_user_agents("identifier1")
    end
