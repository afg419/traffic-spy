...
class UrlTest < ModelTest
  def test_we_can_access_a_specfic_users_url
    load_tables("identifier1", "url1")
    load_tables("identifier2", "url2", {"request_type"=>"POST"})

    client_1 = TrafficSpy::User.find_by(identifier: "identifier1")
    url_1 = client_1.urls
    platform = url_1.first.platform

    assert_equal "Macintosh", platform
...
#
  def test_longest_response_time
    load_tables("identifier1", "url1")
    load_tables("identifier1", "url1", {"responded_in" => 60})
    load_tables("identifier1", "url1", {"responded_in" => 13})
  ...
  def test_we_can_collect_http_verbs_that_have_been_used
    load_tables("identifier1", "url1", {"request_type" => "DELETE"})
    load_tables("identifier1", "url1", {"request_type" => "GET"})
    load_tables("identifier1", "url1", {"request_type" => "POST"})
  ...
  def test_most_popular_referrers_returns_top_3
    load_tables("identifier1", "url1", {"referred_by" => "refer1"})
    load_tables("identifier1", "url1", {"referred_by" => "refer1"})
    load_tables("identifier1", "url1", {"referred_by" => "refer2"})
    load_tables("identifier1", "url1", {"referred_by" => "refer2"})
    load_tables("identifier1", "url1", {"referred_by" => "refer2"})
    load_tables("identifier1", "url1", {"referred_by" => "refer3"})
    load_tables("identifier1", "url1", {"referred_by" => "refer3"})
    load_tables("identifier1", "url1", {"referred_by" => "refer4"})
  ...
  def test_most_popular_user_agents_returns_top_3_browsers
    load_tables("identifier1", "url1", {"browser" => "Chrome"})
    load_tables("identifier1", "url1", {"browser" => "Chrome"})
    load_tables("identifier1", "url1", {"browser" => "Chrome"})
    load_tables("identifier1", "url1", {"browser" => "Firefox"})
    load_tables("identifier1", "url1", {"browser" => "Firefox"})
    load_tables("identifier1", "url1", {"browser" => "Firefox"})
    load_tables("identifier1", "url1", {"browser" => "Firefox"})
    load_tables("identifier1", "url1", {"browser" => "Safari"})
    load_tables("identifier1", "url1", {"browser" => "Safari"})
    load_tables("identifier1", "url1", {"browser" => "Internet Explorer"})
  ...
  def test_we_can_return_average_response_times_per_url_in_descending_order
    load_tables("identifier1", "url1", {"url" => "blog",
                               "responded_in" => 37})
    load_tables("identifier1", "url1", {"url" => "blog",
                               "responded_in" => 38})
    load_tables("identifier1", "url1", {"url" => "about",
                               "responded_in" => 23})
    load_tables("identifier1", "url1", {"url" => "article/1",
                               "responded_in" => 16})
    load_tables("identifier1", "url1", {"url" => "about",
                               "responded_in" => 37})
    load_tables("identifier1", "url1", {"url" => "blog",
  ...
  def test_we_can_return_all_the_requested_urls_in_the_correct_order
    ...
    load_tables("identifier1", "url1", {"url" => "about"})
    load_tables("identifier1", "url1", {"url" => "blog"})
    load_tables("identifier1", "url1", {"url" => "article/2"})
  ...
  def test_we_can_return_all_the_operating_systems_and_their_breakdown
    load_tables("identifier1", "url1", {"platform" => "Macintosh"})
    load_tables("identifier1", "url1", {"platform" => "Macintosh"})
    load_tables("identifier1", "url1", {"platform" => "Macintosh"})
    load_tables("identifier1", "url1", {"platform" => "Microsoft"})
    load_tables("identifier1", "url1", {"platform" => "Linux"})
    load_tables("identifier1", "url1", {"platform" => "Linux"})
  ...
  def test_we_can_return_screen_resolution_for_all_requests
    ...
    load_tables("identifier1", "url1")
    load_tables("identifier1", "url1")
    load_tables("identifier1", "url1", {"resolution_width" => "1366",
                                       "resolution_height" => "768"})
    load_tables("identifier1", "url1", {"resolution_width" => "1920",
                                       "resolution_height" => "1080"})
    load_tables("identifier1", "url1", {"resolution_width" => "1024",
                                       "resolution_height" => "768"})
